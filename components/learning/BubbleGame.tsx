    ...
    <Card className="w-full rounded-2xl p-5 sm:p-6 shadow-xl relative overflow-hidden space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-border/60 pb-4">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <Badge variant="outline" className="gap-1 text-sm font-bold px-2.5 py-0.5 bg-primary/10 text-primary border-primary/20">
      ...
      <div className="grid grid-cols-3 gap-2 sm:gap-4 p-3 rounded-xl bg-muted/40 border border-border font-mono text-sm">
        <div className="flex flex-col">
          <span className="text-sm uppercase text-muted-foreground flex items-center gap-1">
        ...
        <div className="flex flex-col">
          <span className="text-sm uppercase text-muted-foreground flex items-center gap-1">
            <HardDrive className="w-3.5 h-3.5 text-secondary-foreground" />
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between text-sm font-semibold text-foreground">
          ...
          <span className="text-muted-foreground text-sm">Tap slot to remove</span>
        </div>
                ...
                {placed ? (
                  <>
                    <div className="flex items-start justify-between gap-1">
                      <Badge variant="outline" className="text-sm font-mono font-bold px-1.5 py-0.5 rounded bg-primary/10 text-primary border-primary/20">
                        0{slotIdx + 1}
                      </Badge>
                      <button
                        type="button"
                    ...
                    <div className="flex items-center justify-between text-sm font-mono text-muted-foreground mt-2 border-t border-border/40 pt-1">
                  ...
                  <div className="text-center">
                    ...
                    <span className="text-sm text-muted-foreground/80 mt-1 block">
              ...
              >
                <div>
                  <div className="flex items-center justify-between gap-1 mb-1">
                    <Badge variant="secondary" className="text-sm uppercase font-mono px-1.5 py-0.5">
                      {node.category}
                    </Badge>
      ...
      <div className="pt-2 flex items-center justify-end gap-3">
        <Button
          ...
          className="w-full sm:w-auto px-6 py-2.5 rounded-xl text-sm font-bold gap-2"
        >
          {status === 'verifying' ? (
