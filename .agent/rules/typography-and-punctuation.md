...
- Never use em dashes (`—`) or en dashes (`–`) anywhere in this project.
...
- Example:
  ...
  - ✅ `AIgnite - Master Applied AI in 5-Minute Daily Sparks`
- Exception: Third-party vendor-generated blocks (such as the Next.js agent block) that are automatically managed by external CLI tools.

## 2. Typography: Minimum Font Size (`text-sm` or Larger)
- Never use `text-xs` (12px / 0.75rem) anywhere in Tailwind CSS classes. 12px is too small for accessibility, legibility, and mobile usability.
